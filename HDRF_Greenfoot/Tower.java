...
public class Tower extends Actor
{
    ...
    Tower(int id){
        switch(id){
            ...
            case 2: setImage("img/TowerRocket.png");
            break;
        }
        tId = id;
    }
    ...
    public void act()
      {
        ...
        switch(tId){
            case 0:     creepsInRange = getObjectsInRange(120,Creep.class);
             ...
             case 2:    creepsInRange = getObjectsInRange(350,Creep.class);
                        if(placed && creepsInRange.isEmpty()==false){
                            if(placed && creepsInRange.get(0)!=null){
                                for(int i = 0;creepsInRange.size()>i;i++){
                                    Creep temp = (Creep)creepsInRange.get(i);
        ...
        if (Greenfoot.mousePressed(this) && !isGrabbed && dragAllowed && !placed)
        {
            ...
            switch(tId){
                ...
                case 1: Tower tower1 = new Tower(tId);
                        ...
                        break;
                case 2: Tower tower2 = new Tower(tId);
                        world.addObject(tower2, MyWorld.t2x,MyWorld.t2y);
                        break;
            }
            return;
        }
